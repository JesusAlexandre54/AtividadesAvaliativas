...
public class DesenvolvimentoParaDispositivosMoveisQuestoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desenvolvimento_para_dispositivos_moveis_questoes);
        ...
        bt_resposta.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                Toast.makeText(DesenvolvimentoParaDispositivosMoveisQuestoes.this, "É necessario selecionar uma ersposta!", Toast.LENGTH_SHORT).show();
                return;
            }else{
        ...
        bt_finalizar.setOnClickListener(view -> {
            Intent i = new Intent(DesenvolvimentoParaDispositivosMoveisQuestoes.this, DesenvolvimentoParaDispositivosMoveisFim.class);
        ...
        bt_continuar.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                ...
                Toast.makeText(DesenvolvimentoParaDispositivosMoveisQuestoes.this, "É necessario uma responder antes de continuar!", Toast.LENGTH_SHORT).show();

            }else{
                Questao+=1;
                Intent i = new Intent(DesenvolvimentoParaDispositivosMoveisQuestoes.this, DesenvolvimentoParaDispositivosMoveis.class);
                i.putExtra("placar",Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);}
        });
