...
public class InterfaceHumanoComputadorFim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interface_humano_computador_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(InterfaceHumanoComputadorFim.this, MainActivity.class);
            startActivity(i);
