...
public class SistemasEmbarcadosFim extends AppCompatActivity {
    int Placar, Questao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sistemas_embarcados_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(SistemasEmbarcadosFim.this, MainActivity.class);
            startActivity(i);
