...
public class SistemasEmbarcadosQuestoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sistemas_embarcados_questoes);
        ...
        bt_resposta.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                Toast.makeText(SistemasEmbarcadosQuestoes.this, "É necessario selecionar uma ersposta!", Toast.LENGTH_SHORT).show();
                return;
            }else{
        ...
        bt_finalizar.setOnClickListener(view -> {
            Intent i = new Intent(SistemasEmbarcadosQuestoes.this, SistemasEmbarcadosFim.class);
        ...
        bt_continuar.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                ...
                Toast.makeText(SistemasEmbarcadosQuestoes.this, "É necessario uma responder antes de continuar!", Toast.LENGTH_SHORT).show();

            }else{
                Questao+=1;
                Intent i = new Intent(SistemasEmbarcadosQuestoes.this, SistemasEmbarcados.class);
                i.putExtra("placar",Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);}
        });
