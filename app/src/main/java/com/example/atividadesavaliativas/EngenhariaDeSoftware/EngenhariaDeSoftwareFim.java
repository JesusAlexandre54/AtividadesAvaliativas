...
public class EngenhariaDeSoftwareFim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_engenharia_de_software_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(EngenhariaDeSoftwareFim.this, MainActivity.class);
            startActivity(i);
