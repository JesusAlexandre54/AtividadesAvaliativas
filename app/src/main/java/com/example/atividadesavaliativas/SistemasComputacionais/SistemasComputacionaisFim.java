...
public class SistemasComputacionaisFim extends AppCompatActivity {
    int Placar, Questao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sistemas_computacionais_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(SistemasComputacionaisFim.this, MainActivity.class);
            startActivity(i);
