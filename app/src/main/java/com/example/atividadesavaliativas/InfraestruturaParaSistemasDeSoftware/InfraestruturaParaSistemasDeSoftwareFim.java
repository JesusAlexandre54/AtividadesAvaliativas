...
public class InfraestruturaParaSistemasDeSoftwareFim extends AppCompatActivity {
    int Placar, Questao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infraestrutura_para_sistemas_de_software_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(InfraestruturaParaSistemasDeSoftwareFim.this, MainActivity.class);
            startActivity(i);
