...
public class GestaoDaInovacaoeDesenvolvimentoDeProdutosFim extends AppCompatActivity {
    int Placar, Questao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gestao_da_inovacaoe_desenvolvimento_de_produtos_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(GestaoDaInovacaoeDesenvolvimentoDeProdutosFim.this, MainActivity.class);
            startActivity(i);
