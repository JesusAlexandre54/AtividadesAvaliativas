...
public class GestaoDaInovacaoeDesenvolvimentoDeProdutosQuestoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gestao_da_inovacaoe_desenvolvimento_de_produtos_questoes);
        ...
        bt_resposta.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                Toast.makeText(GestaoDaInovacaoeDesenvolvimentoDeProdutosQuestoes.this, "É necessario selecionar uma ersposta!", Toast.LENGTH_SHORT).show();
                return;
            }else{
        ...
        bt_finalizar.setOnClickListener(view -> {
            Intent i = new Intent(GestaoDaInovacaoeDesenvolvimentoDeProdutosQuestoes.this, GestaoDaInovacaoeDesenvolvimentoDeProdutosFim.class);
        ...
        bt_continuar.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                ...
                Toast.makeText(GestaoDaInovacaoeDesenvolvimentoDeProdutosQuestoes.this, "É necessario uma responder antes de continuar!", Toast.LENGTH_SHORT).show();

            }else{
                Questao+=1;
                Intent i = new Intent(GestaoDaInovacaoeDesenvolvimentoDeProdutosQuestoes.this, GestaoDaInovacaoeDesenvolvimentoDeProdutos.class);
                i.putExtra("placar",Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);}
        });
