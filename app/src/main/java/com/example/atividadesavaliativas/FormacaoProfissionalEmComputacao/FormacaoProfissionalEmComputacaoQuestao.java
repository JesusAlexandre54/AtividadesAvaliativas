...
public class FormacaoProfissionalEmComputacaoQuestao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_formacao_profissional_em_computacao_questao);
        ...
        bt_resposta.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                Toast.makeText(FormacaoProfissionalEmComputacaoQuestao.this, "É necessario selecionar uma ersposta!", Toast.LENGTH_SHORT).show();
                return;
            }else{
        ...
        bt_finalizar.setOnClickListener(view -> {
            Intent i = new Intent(FormacaoProfissionalEmComputacaoQuestao.this, FormacaoProfissionalEmComputacaoFim.class);
        ...
        bt_continuar.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                ...
                Toast.makeText(FormacaoProfissionalEmComputacaoQuestao.this, "É necessario uma responder antes de continuar!", Toast.LENGTH_SHORT).show();

            }else{
                Questao+=1;
                Intent i = new Intent(FormacaoProfissionalEmComputacaoQuestao.this, FormacaoProfissionalEmComputacao.class);
                i.putExtra("placar",Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);}
        });
