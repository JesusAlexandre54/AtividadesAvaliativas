...
public class FormacaoProfissionalEmComputacaoFim extends AppCompatActivity {
    int Placar, Questao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_formacao_profissional_em_computacao_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(FormacaoProfissionalEmComputacaoFim.this, MainActivity.class);
            startActivity(i);
