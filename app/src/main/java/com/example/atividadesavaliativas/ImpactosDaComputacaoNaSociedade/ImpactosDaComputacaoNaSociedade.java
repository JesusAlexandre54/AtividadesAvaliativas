...
public class ImpactosDaComputacaoNaSociedade extends AppCompatActivity {
    Intent i;
    int Placar, Questao;
    boolean fim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_impactos_da_computacao_na_sociedade);
        ...
        new Handler().postDelayed(() -> {
            if (resp1==null){
                Questao-=1;
                i = new Intent(ImpactosDaComputacaoNaSociedade.this, ImpactosDaComputacaoNaSociedadeFim.class);
                i.putExtra("placar", Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);

            }else {
                i = new Intent(ImpactosDaComputacaoNaSociedade.this, ImpactosDaComputacaoNaSociedadeQuestoes.class);
                i.putExtra("placar", Placar);
                i.putExtra("questaoEscolhida", Questao);
