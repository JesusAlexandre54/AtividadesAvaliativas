...
public class ImpactosDaComputacaoNaSociedadeFim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_impactos_da_computacao_na_sociedade_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(ImpactosDaComputacaoNaSociedadeFim.this, MainActivity.class);
            startActivity(i);
