...
public class ProtocolosDeComunicacaoIot extends AppCompatActivity {
    Intent i;
    int Placar, Questao;
    boolean fim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protocolos_de_comunicacao_iot);
        ...
        new Handler().postDelayed(() -> {
            if (resp1==null){
                Questao-=1;
                i = new Intent(ProtocolosDeComunicacaoIot.this, ProtocolosDeComunicacaoIotFim.class);
                i.putExtra("placar", Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);

            }else {
                i = new Intent(ProtocolosDeComunicacaoIot.this, ProtocolosDeComunicacaoIotQuestoes.class);
                i.putExtra("placar", Placar);
                i.putExtra("questaoEscolhida", Questao);
