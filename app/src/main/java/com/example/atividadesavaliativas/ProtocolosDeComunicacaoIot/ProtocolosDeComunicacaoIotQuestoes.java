package com.example.atividadesavaliativas.ProtocolosDeComunicacaoIot;
...
public class ProtocolosDeComunicacaoIotQuestoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protocolos_de_comunicacao_iot_questoes);
        ...
        db.collection("ProtocolosDeComunicacaoIot").document(questao_aleatoria)
        ...
        bt_resposta.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                Toast.makeText(ProtocolosDeComunicacaoIotQuestoes.this, "É necessario selecionar uma ersposta!", Toast.LENGTH_SHORT).show();
                return;
            }else{
        ...
        bt_finalizar.setOnClickListener(view -> {
            Intent i = new Intent(ProtocolosDeComunicacaoIotQuestoes.this, ProtocolosDeComunicacaoIotFim.class);
        ...
        bt_continuar.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                ...
                Toast.makeText(ProtocolosDeComunicacaoIotQuestoes.this, "É necessario uma responder antes de continuar!", Toast.LENGTH_SHORT).show();

            }else{
                Questao+=1;
                Intent i = new Intent(ProtocolosDeComunicacaoIotQuestoes.this, ProtocolosDeComunicacaoIot.class);
                i.putExtra("placar",Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);}
        });
