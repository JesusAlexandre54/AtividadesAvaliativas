...
public class ProtocolosDeComunicacaoIotFim extends AppCompatActivity {
    int Placar, Questao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protocolos_de_comunicacao_iot_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(ProtocolosDeComunicacaoIotFim.this, MainActivity.class);
            startActivity(i);
