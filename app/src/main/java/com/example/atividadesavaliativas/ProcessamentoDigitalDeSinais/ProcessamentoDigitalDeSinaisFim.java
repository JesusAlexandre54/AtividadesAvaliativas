...
public class ProcessamentoDigitalDeSinaisFim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_processamento_digital_de_sinais_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(ProcessamentoDigitalDeSinaisFim.this, MainActivity.class);
            startActivity(i);
