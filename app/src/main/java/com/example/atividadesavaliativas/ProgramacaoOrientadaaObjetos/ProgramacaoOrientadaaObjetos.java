...
public class ProgramacaoOrientadaaObjetos extends AppCompatActivity {
    Intent i;
    int Placar, Questao;
    boolean fim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_programacao_orientadaa_objetos);
        ...
        new Handler().postDelayed(() -> {
            if (resp1==null){
                Questao-=1;
                i = new Intent(ProgramacaoOrientadaaObjetos.this, ProgramacaoOrientadaaObjetosFim.class);
                i.putExtra("placar", Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);

            }else {
                i = new Intent(ProgramacaoOrientadaaObjetos.this, ProgramacaoOrientadaaObjetosQuestoes.class);
                i.putExtra("placar", Placar);
                i.putExtra("questaoEscolhida", Questao);
