package com.example.atividadesavaliativas.ProgramacaoOrientadaaObjetos;
...
public class ProgramacaoOrientadaaObjetosQuestoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_programacao_orientadaa_objetos_questoes);
        ...
        db.collection("ProgramacaoOrientadaaObjetos").document(questao_aleatoria)
        ...
        bt_resposta.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                Toast.makeText(ProgramacaoOrientadaaObjetosQuestoes.this, "É necessario selecionar uma ersposta!", Toast.LENGTH_SHORT).show();
                return;
            }else{
        ...
        bt_finalizar.setOnClickListener(view -> {
            Intent i = new Intent(ProgramacaoOrientadaaObjetosQuestoes.this, ProgramacaoOrientadaaObjetosFim.class);
        ...
        bt_continuar.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                ...
                Toast.makeText(ProgramacaoOrientadaaObjetosQuestoes.this, "É necessario uma responder antes de continuar!", Toast.LENGTH_SHORT).show();

            }else{
                Questao+=1;
                Intent i = new Intent(ProgramacaoOrientadaaObjetosQuestoes.this, ProgramacaoOrientadaaObjetos.class);
                i.putExtra("placar",Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);}
        });
