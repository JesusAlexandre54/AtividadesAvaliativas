...
public class ProgramacaoOrientadaaObjetosFim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_programacao_orientadaa_objetos_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(ProgramacaoOrientadaaObjetosFim.this, MainActivity.class);
            startActivity(i);
