...
public class BancoDeDadosFim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banco_de_dados_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(BancoDeDadosFim.this, MainActivity.class);
            startActivity(i);
