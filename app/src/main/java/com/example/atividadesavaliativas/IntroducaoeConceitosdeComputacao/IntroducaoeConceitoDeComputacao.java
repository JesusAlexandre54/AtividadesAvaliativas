...
public class IntroducaoeConceitoDeComputacao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_introducaoe_conceito_de_computacao);
        ...
        new Handler().postDelayed(() -> {
            if (resp1==null){
                Questao-=1;
                i = new Intent(IntroducaoeConceitoDeComputacao.this, IntroducaoeConceitoDeComputacaoFim.class);
                i.putExtra("placar", Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);

            }else {
                i = new Intent(IntroducaoeConceitoDeComputacao.this, IntroducaoeConceitosDeComputacaoQuestoes.class);
                i.putExtra("placar", Placar);
                i.putExtra("questaoEscolhida", Questao);
