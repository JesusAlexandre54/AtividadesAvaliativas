...
public class IntroducaoeConceitoDeComputacaoFim extends AppCompatActivity {
    int Placar, Questao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_introducaoe_conceito_de_computacao_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(IntroducaoeConceitoDeComputacaoFim.this, MainActivity.class);
            startActivity(i);
