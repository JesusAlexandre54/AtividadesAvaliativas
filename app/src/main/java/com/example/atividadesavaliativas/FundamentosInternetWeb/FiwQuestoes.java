...
public class FiwQuestoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fiw_questoes);
        ...
        bt_resposta.setOnClickListener(this::onClick);

        bt_finalizar.setOnClickListener(view -> {
            Intent i = new Intent(FiwQuestoes.this, FiwFim.class);
        ...
        bt_continuar.setOnClickListener(view -> {
            ...
            if (!(a.isChecked()||b.isChecked()||c.isChecked()||d.isChecked()||e.isChecked())){
                Toast.makeText(FiwQuestoes.this, "É necessario selecionar uma ersposta!", Toast.LENGTH_SHORT).show();

            } else if ( resposta.equals("")){

                Toast.makeText(FiwQuestoes.this, "É necessario uma responder antes de continuar!", Toast.LENGTH_SHORT).show();

            }else{
                Questao+=1;


                Intent i = new Intent(FiwQuestoes.this, FundamentosInternetWeb.class);
                i.putExtra("placar",Placar);
                i.putExtra("questaoEscolhida",Questao);
