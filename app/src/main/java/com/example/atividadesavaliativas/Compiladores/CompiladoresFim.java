...
public class CompiladoresFim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compiladores_fim);
        ...
        reiniciar.setOnClickListener(view -> {
            ...
            Intent i = new Intent(CompiladoresFim.this, MainActivity.class);
            startActivity(i);
        });
