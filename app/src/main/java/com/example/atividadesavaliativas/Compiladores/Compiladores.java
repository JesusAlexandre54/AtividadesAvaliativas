...
public class Compiladores extends AppCompatActivity {
    Intent i;
    int Placar, Questao;
    boolean fim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compiladores);
        ...
        new Handler().postDelayed(() -> {
            if (resp1==null){
                Questao-=1;
                i = new Intent(Compiladores.this, CompiladoresFim.class);
                i.putExtra("placar", Placar);
                i.putExtra("questaoEscolhida",Questao);
                startActivity(i);

            }else {
                i = new Intent(Compiladores.this, CompiladoresQuestoes.class);
                i.putExtra("placar", Placar);
                i.putExtra("questaoEscolhida", Questao);
